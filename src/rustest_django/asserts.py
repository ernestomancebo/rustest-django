"""Every assert* method of Django's TestCase family, as module-level
functions. Ported from pytest-django's asserts.py near-verbatim: the
mechanism is pure Django/unittest, nothing rustest-specific.
"""
