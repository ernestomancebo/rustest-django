...
# with assertTemplateUsed("template.html"): ...
@overload
...
# with assertTemplateUsed(template_name="template.html"): ...
@overload
def assertTemplateUsed(
    response: None = ...,
...
# assertTemplateUsed(response, "template.html")
@overload
def assertTemplateUsed(
    response: HttpResponseBase,
    template_name: str | None = ...,
...
# with assertTemplateNotUsed("template.html"): ...
@overload
...
# with assertTemplateNotUsed(template_name="template.html"): ...
@overload
def assertTemplateNotUsed(
    response: None = ...,
    template_name: str | None = ...,
...
# assertTemplateNotUsed(response, "template.html")
@overload
def assertTemplateNotUsed(
    response: HttpResponseBase,
    template_name: str | None = ...,
